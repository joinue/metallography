  ...
  const chemicals = [
    {
      ...
      cas: '7697-37-2',
      hazards: 'Corrosive, oxidizing, toxic. Releases orange-brown NOₓ fumes that are toxic to the lungs and can cause delayed pulmonary edema.',
    ...
    },
    {
      ...
      storage: 'Store wetted with 10–20% water (visible water layer at all times). Use plastic or amber-glass bottles with plastic-lined caps — NEVER metal caps or metal-lined closures. Keep away from copper, lead, zinc, and other metals (reactive metals form shock-sensitive picrate salts). Store away from heat, sparks, oxidizers, and reducing agents. Inspect periodically for water-layer loss; refill before crystals dry out.',
    ...
    },
    {
      ...
      handling: 'Use ONLY in a perchloric-rated wash-down fume hood with dedicated ductwork — NEVER a standard organic-chemistry fume hood. For metallographic electropolishing, use a purpose-built chilled electropolishing cell rather than benchtop mixing. Wear acid-resistant gloves, full face shield, splash apron, and lab coat. Add acid to water slowly, with cooling.',
