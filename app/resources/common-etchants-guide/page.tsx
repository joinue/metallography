...
// Helper function to get shop URLs for etchants available as pre-mixed solutions
...
export default function CommonEtchantsGuidePage() {
  ...
  const downloadPDF = async () => {
    ...
    const carbonSteelEtchants = [
      ...
      { name: '8% Nital', comp: 'Ethanol, HNO₃ (8%)', app: 'Very aggressive, for very hard steels and tool steels. Concentrations above 5% are less stable in storage — keep fresh.', time: '5-30 sec', pace: true, shopUrl: getEtchantShopUrl('8% Nital') },
      { name: '10% Nital', comp: 'Ethanol, HNO₃ (10%)', app: 'Most aggressive Nital, for extremely hard materials. Unstable — mix immediately before use and never store; HNO₃ concentrations above 10% in ethanol are dangerous to store.', time: '5-30 sec', pace: false, shopUrl: null },
      ...
      { name: "Vilella's Reagent", comp: 'Picric Acid (1g), HCl (5ml), Ethanol (95ml)', app: 'For ferrite-carbide structures in steels. Also used for stainless steel.', time: '5-60 sec', pace: true, shopUrl: getEtchantShopUrl("Vilella's Reagent") },
    ...
    const stainlessEtchants = [
      { name: "Vilella's Reagent", comp: 'Picric Acid (1g), HCl (5ml), Ethanol (95ml)', app: 'General purpose, most versatile for stainless steel. Works well for most grades, especially martensitic and ferritic.', time: '5-60 sec', pace: true },
      ...
      { name: "Kallings No. 2", comp: 'CuCl₂ (5g), HCl (100ml), Ethanol (100ml)', app: 'Waterless Kalling\'s — duplex and austenitic stainless steels and nickel-base alloys. Produces good contrast.', time: '10-30 sec at 20°C', pace: true },
      ...
      { name: 'Aqua Regia', comp: '3 parts HCl : 1 part HNO₃', app: 'For austenitic stainless steels. Very aggressive - reveals grain boundaries and twin boundaries. Mix fresh in a fume hood; never store the mixture — it evolves gas and pressurizes sealed containers.', time: '5-15 sec', pace: false },
      { name: 'Glyceregia', comp: 'HNO₃ (10ml), HCl (20ml), Glycerol (30ml)', app: 'General etchant for austenitic and ferritic stainless steels; also reveals sigma phase and intermetallics in duplex grades. Mix fresh — activity decays; never store the mixture.', time: '10-60 sec immersion', pace: false },
      { name: 'Electrolytic (10% Oxalic Acid)', comp: 'Oxalic Acid (10g), Water (100ml)', app: 'Electrolytic etching for austenitic stainless steel; reveals sensitization (chromium carbide "ditching") per ASTM A262 Practice A. Use at 6V, stainless steel cathode.', time: '30-90 sec at 6V', pace: false },
    ]
    ...
    const aluminumEtchants = [
      { name: "Keller's Reagent", comp: 'DI Water (190ml), HNO₃ (5ml), HCl (3ml), HF (2ml)', app: 'Standard etchant for aluminum and aluminum alloys. Reveals grain boundaries and precipitates. Most common. Contains HF — fume hood and HF-rated PPE required.', time: '5-30 sec swab', pace: true, shopUrl: getEtchantShopUrl("Keller's Reagent") },
      ...
      { name: "Weck's Tint Etch (Al)", comp: 'KMnO₄ (4g), NaOH (1g), Water (100ml)', app: 'Tint etch for aluminum alloys — different phases show different colors. Apply by immersion on a deformation-free surface.', time: '30-60 sec immersion', pace: true, shopUrl: getEtchantShopUrl("Weck's Etch") },
      ...
      { name: "Barker's Reagent (anodizing)", comp: 'HBF₄ (5ml), Water (200ml)', app: 'Anodizing technique for aluminum, not a chemical etch — grows an anodic film that reveals grain orientation contrast under polarized light. Use at ~20V DC.', time: '60-120 sec at 20V', pace: false, shopUrl: null },
    ]
    ...
    const copperEtchants = [
      ...
      { name: 'Ammonium Hydroxide + H₂O₂', comp: 'NH₄OH (50ml), H₂O₂ 3% (50ml) — equal volumes', app: 'Standard etchant for copper and brass. Reveals grain boundaries and twins. Mix immediately before use — activity decays in minutes; never store the mixture sealed.', time: '10-60 sec swab', pace: false, shopUrl: null },
      ...
      { name: 'Ammonium Persulfate', comp: '(NH₄)₂S₂O₈ (50g), Distilled water (245ml)', app: 'For copper and copper alloys, including brass. Reveals grain boundaries and phase structure.', time: '10-30 sec', pace: true, shopUrl: getEtchantShopUrl("Ammonium Persulfate") },
    ]
    ...
    const titaniumEtchants = [
      { name: "Kroll's Reagent", comp: 'DI Water (92ml), HNO₃ (6ml), HF (2ml)', app: 'Standard etchant for titanium and titanium alloys. Reveals alpha and beta phases. Most common. Swab; never let the surface dry between application and rinse — HF residue continues to attack.', time: '5-15 sec swab', pace: true, shopUrl: getEtchantShopUrl("Kroll's Reagent") },
    ...
    const nickelEtchants = [
      ...
      { name: "Modified Marble's", comp: 'CuSO₄ (4g), HCl (20ml), Water (20ml)', app: 'Variant of Marble\'s used for Ni-base superalloys (Inconel 718, Rene 41); modified versions are also applied electrolytically at ~6V for superalloy structures.', time: '5-60 sec', pace: false, shopUrl: null },
      { name: 'Aqua Regia', comp: '3 parts HCl : 1 part HNO₃', app: 'Standard etchant for nickel alloys. Very aggressive - reveals grain boundaries and phases. Mix fresh in a fume hood; never store the mixture — it evolves gas and pressurizes sealed containers.', time: '5-15 sec', pace: false, shopUrl: null },
      { name: 'Glyceregia', comp: 'HNO₃ (10ml), HCl (20ml), Glycerol (30ml)', app: 'For nickel-based superalloys. Reveals gamma prime and other phases. Mix fresh — activity decays; never store the mixture.', time: '10-60 sec immersion', pace: false, shopUrl: null },
    ...
    const castIronEtchants = [
      ...
      { name: "Stead's Reagent", comp: 'CuCl₂ (2g), HCl (40ml), Water (30-50ml), Ethanol (25-40ml)', app: 'For revealing phosphorus segregation and dendritic/solidification structure in cast iron — deposits copper preferentially on low-phosphorus regions.', time: '30-90 sec', pace: false, shopUrl: null },
    ...
    const toolSteelEtchants = [
      ...
      { name: '8% Nital', comp: 'Ethanol, HNO₃ (8%)', app: 'For very hard tool steels requiring aggressive etching. Reveals martensite and complex structures. Concentrations above 5% are less stable in storage — keep fresh.', time: '5-30 sec', pace: true },
      ...
      { name: "Murakami's Reagent", comp: 'K₃Fe(CN)₆ (10g), NaOH (10g), Water (100ml)', app: 'For revealing carbides in tool steels. Colors different carbides differently. Dissolve NaOH in water FIRST, then add K₃Fe(CN)₆. Never mix with acids — ferricyanide + acid releases hydrogen cyanide.', time: '5-30 sec swab (longer for deep carbide contrast)', pace: true, shopUrl: getEtchantShopUrl("Murakami's Reagent") },
    ]
        ...
        <div className="max-w-4xl mx-auto">
              ...
              <section id="stainless-steel" className="scroll-mt-24">
                ...
                <div className="space-y-3">
                  <div className="border-l-4 border-primary-500 pl-4">
                    ...
                    <p className="text-sm text-gray-600"><strong>Composition:</strong> Picric Acid (1g), HCl (5ml), Ethanol (95ml)</p>
                    <p className="text-sm text-gray-600"><strong>Application:</strong> General purpose, most versatile for stainless steel. Works well for most grades, especially martensitic and ferritic.</p>
                    <p className="text-sm text-gray-600"><strong>Time:</strong> 5-60 seconds</p>
                  </div>
                  <div className="border-l-4 border-primary-500 pl-4">
                    <div className="flex items-center gap-2 mb-1">
                  ...
                  <div className="border-l-4 border-gray-400 pl-4">
                    ...
                    <p className="text-sm text-gray-600"><strong>Application:</strong> For austenitic stainless steels. Very aggressive - reveals grain boundaries and twin boundaries. Mix fresh in a fume hood; never store the mixture — it evolves gas and pressurizes sealed containers.</p>
              ...
              <section id="aluminum" className="scroll-mt-24">
                ...
                <div className="space-y-3">
                  <div className="border-l-4 border-primary-500 pl-4">
                    ...
                    <p className="text-sm text-gray-600"><strong>Application:</strong> Standard etchant for aluminum and aluminum alloys. Reveals grain boundaries and precipitates. Most common. Contains HF — fume hood and HF-rated PPE required.</p>
                    <p className="text-sm text-gray-600"><strong>Time:</strong> 5-30 seconds (swab)</p>
                  </div>
                  <div className="border-l-4 border-gray-400 pl-4">
              ...
              <section id="nickel-alloys" className="scroll-mt-24">
                ...
                <div className="space-y-3">
                  ...
                  <div className="border-l-4 border-gray-400 pl-4">
                    ...
                    <p className="text-sm text-gray-600"><strong>Composition:</strong> HNO₃ (10ml), HCl (20ml), Glycerol (30ml)</p>
                    <p className="text-sm text-gray-600"><strong>Application:</strong> For nickel-based superalloys. Reveals gamma prime and other phases. Mix fresh — activity decays; never store the mixture.</p>
                    <p className="text-sm text-gray-600"><strong>Time:</strong> 10-60 seconds (immersion)</p>
                  </div>
                </div>
              </section>
          ...
          <div className="mt-8 bg-primary-50 border-l-4 border-primary-600 p-6 rounded">
            ...
            <p className="text-gray-700 text-sm mb-4">
              For etchants beyond this quick reference, the Materials Prep etchant database (built by
              PACE Technologies) covers thousands of etchants searchable by material and method — free-tier
              memberships are available. Or check out our preparation guides.
            </p>
            <div className="flex flex-col sm:flex-row gap-3">
              <a href="https://materialsprep.com" target="_blank" rel="noopener noreferrer" className="text-primary-600 font-semibold hover:underline">
                Browse the Materials Prep etchant database →
              </a>
